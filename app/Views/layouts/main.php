...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex me-3" role="search" action="/search">
                    <div class="input-group">
                        <input class="form-control border-secondary border-end-0" type="search" placeholder="Tìm sản phẩm..." aria-label="Search">
    ...
    <div class="container py-4">
        ...
        <main class="bg-white p-0 rounded shadow-sm overflow-hidden" style="min-height: 400px;">
            <?= $content ?>
        </main>
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="text-center text-md-end">
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><a href="#" class="btn-floating btn-sm text-white fs-5"><i class="bi bi-facebook"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="btn-floating btn-sm text-white fs-5"><i class="bi bi-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="btn-floating btn-sm text-white fs-5"><i class="bi bi-google"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
